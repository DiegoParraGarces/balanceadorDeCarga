...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :cliente2Ubuntu do |cliente2Ubuntu|
    cliente2Ubuntu.vm.box = "bento/ubuntu-22.04"
    cliente2Ubuntu.vm.network :private_network, ip: "192.168.100.4"
    cliente2Ubuntu.vm.hostname = "cliente2Ubuntu"
    cliente2Ubuntu.vm.synced_folder ".", "/vagrant"
    cliente2Ubuntu.vm.provision "shell", inline: $install_puppet
    cliente2Ubuntu.vm.provision :puppet do |puppet|
      puppet.manifests_path = "puppet/manifests"
      puppet.manifest_file = "site.pp"
      puppet.module_path = "puppet/modules"
    end
